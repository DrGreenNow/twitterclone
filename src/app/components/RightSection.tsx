...
const RightSection = () => {
    return (
<section className="w-full sticky hidden top-0 overflow-y-auto mt-4 xl:flex flex-col items-stretch h-[90vh] overflow-x-hidden px-6">
<div>
  <div className="relative w-full h-full group">
    <input id="searchBox" type="text" placeholder="Search Twitter" className="peer w-full h-full rounded-xl py-4 pl-10 px-6 outline-none bg-neutral-900/90 focus:border-primary focus:border"/>
...
<div className="flex flex-col rounded-xl bg-neutral-900 my-4">
  <h3 className="font-bold text-2xl my-4 px-4">What`s happening?</h3>
  <div>
    {
